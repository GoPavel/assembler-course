...
- 16 битный процессор
    ...
    - 286 процессор вычислял физ. адрес = seg * 16 + off
        - Это было сделано, чтобы используя 16-битные регистры можно использовать для 20-битных адресов.
...
**NB)** В 32bit у нас, так называемая Flat-module памяти. Когда у нас все базы сегментов равны 0 и лимит 4Kb
